  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `url(${discrict?.cover})`,
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white container-xxl">
          <h1 className="font-serif text-6xl font-extrabold">{discrict?.name} district</h1>
          <p className="mt-3 text-3xl">
            {discrict?.description}
          </p>
        </div>
      </section>
              ...
              <div key={c.id} className="bg-[#121212] p-3 rounded-xl">
                ...
                <div className="mt-3">
                  ...
                  <div className="mt-3 space-y-1 text-xs text-gray-300">
                    <div>Distance : {"DISTANCE HERE"} km</div>
                    <div>Estimated transport fee : Rs.{"FEE HERE"}</div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 mt-4">
                    {c.disabled ? (
                      <button
                        disabled
                        className="opacity-50 cursor-not-allowed btn-dark"
                        title="Booking not available"
                      >
                        Book Cab
                      </button>
                    ) : c.to ? (
                      <Link to={c.to} className="btn-dark">
                        Book Cab
                      </Link>
                    ) : (
